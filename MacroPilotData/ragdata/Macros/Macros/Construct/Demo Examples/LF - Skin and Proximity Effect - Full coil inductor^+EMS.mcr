...
' History of Changes
' ------------------
' 01-Nov-2023 mha: Changed from conductor driven by Coil Segment to full coil (from solid)
...
Sub Main
	...
	sHistoryCaption = "align wcs with global coordinates"
	sHistoryContent = ""
	sHistoryContent = sHistoryContent & "WCS.AlignWCSWithGlobalCoordinates" & vbCrLf & vbCrLf
	AddToHistory(sHistoryCaption, sHistoryContent)

	sHistoryCaption = "rotate wcs around v +90 degrees"
	sHistoryContent = ""
	sHistoryContent = sHistoryContent & "WCS.RotateWCS ""v"", ""90""" & vbCrLf & vbCrLf
	AddToHistory(sHistoryCaption, sHistoryContent)
	...
	sHistoryContent = sHistoryContent & "    .ProfileCenter ""-3.5934180939669e-11"", ""18"", ""0.52500000000067""" & vbCrLf
	sHistoryContent = sHistoryContent & "    .ProfileNormal ""0.99982765782364"", ""1.7763568394003e-10"", ""-0.01856487680807""" & vbCrLf
	sHistoryContent = sHistoryContent & "    .ProjectProfileToPathAdvanced ""True""" & vbCrLf
	sHistoryContent = sHistoryContent & "    .AddSolid ""component1:conductor""" & vbCrLf
	sHistoryContent = sHistoryContent & "    .Create" & vbCrLf
	sHistoryContent = sHistoryContent & "End With" & vbCrLf & vbCrLf
	AddToHistory(sHistoryCaption, sHistoryContent)
