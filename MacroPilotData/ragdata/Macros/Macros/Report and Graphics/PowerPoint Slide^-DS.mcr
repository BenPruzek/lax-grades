...
Sub Main ()
        ...
        '######################################################################
					...
					If bGrad Then
						...
						Plot.SetBackgroundColor("1", "1", "1")
						'store view
						If Plot.IsDrawnBy3DViewer Then
							Wait 0.2
							VectorPlot3D.type "ifx ifxOpenSGSurfaceMesh3DViewer_PortMode@hybridWireFrame@1"
							VectorPlot3D.type "ifx ifxOpenSGSurfaceMesh3DViewer_PortMode@hybridWireFrame@0"
							Wait 0.1
							ExportImageToClipboard 0,0
							Wait 0.2
						Else
